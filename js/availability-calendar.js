(function ($) {
	...
	var months = ['Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Ao�t', 'Septembre', 'Octobre', 'Novembre', 'Décembre'];
	...
	AvailabilityCalendar.prototype = {
		...
		__createToolbar: function () {
			...
			$inputContainer.append('<input type="button" title="Ce mois" value="Ce mois">');
			$inputContainer.append('<input type="button" title="Mois précédent" value="&#10094;">');
			$inputContainer.append('<input type="button" title="Mois suivant" value="&#10095;">');
